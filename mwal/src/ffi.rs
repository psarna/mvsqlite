...
#[repr(C)]
pub struct Wal {
    pub(crate) vfs: *const sqlite3_vfs,
    pub(crate) db_fd: *mut sqlite3_file,
    pub(crate) wal_fd: *mut sqlite3_file,
    pub(crate) callback_value: u32,
    pub(crate) max_wal_size: i64,
    pub(crate) wi_data: i32,
    pub(crate) size_first_block: i32,
    pub(crate) ap_wi_data: *const *mut u32,
    pub(crate) page_size: u32,
    pub(crate) read_lock: i16,
    pub(crate) sync_flags: u8,
    pub(crate) exclusive_mode: u8,
    pub(crate) write_lock: u8,
    pub(crate) checkpoint_lock: u8,
    pub(crate) read_only: u8,
    pub(crate) truncate_on_commit: u8,
    pub(crate) sync_header: u8,
    pub(crate) pad_to_section_boundary: u8,
    pub(crate) b_shm_unreliable: u8,
    ...
    pub(crate) p_db: *const c_void,
    pub(crate) wal_methods: *mut libsql_wal_methods,
    pub(crate) mvfs_context: *mut MvfsContext,
}
...
pub struct libsql_wal_methods {
    ...
    pub xDbSize: extern "C" fn(wal: *mut Wal) -> u32,
...
pub struct MvfsContext {
    pub mvfs: mvfs::MultiVersionVfs,
    pub connection: mvfs::Connection,
